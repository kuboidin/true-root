...
export const metadata = {
    title: 'How to Grow any vegetables at Home - Complete Guide for vegetables.',
    description: 'Discover easy, step-by-step guides for growing vegetables at home, in the garden, or on your balcony. Learn soil requirements, watering schedules, and organic care tips for each plant.',
    keywords:  ["grow vegetables at home", "grow herbs indoors", "balcony gardening tips", "organic gardening guide", "grow fruits at home", "plant care tips", "watering schedule plants", "soil mix guide for plants", "beginner gardening tips"],
    openGraph: {
        title: 'How to Grow any vegetables at Home - Complete Guide for vegetables.',
        description: 'Discover easy, step-by-step guides for growing vegetables at home, in the garden, or on your balcony. Learn soil requirements, watering schedules, and organic care tips for each plant.',
        images: [
            {
                ...
                width: 1517,
                height: 727,
                alt: 'How to Grow any vegetables at Home - Complete Guide for vegetables.',
            },
        ],
        url: `${app.url}/how-to-grow/vegetables`,
        type: 'website'
    },
    twitter: {
        title: 'How to Grow any vegetables at Home - Complete Guide for vegetables.',
    ...
    alternates: {
        canonical: `${app.url}/how-to-grow/vegetables`,
    }
};
...
export default function Page() {
    ...
    const plants = gc.filter(g => g.category.includes(category.VEGETABLE));
        ...
        <div className="relative min-h-[250px] max-sm:min-h-[230px] bg-cover bg-center z-[2] w-full overlay-black-light before:bg-black before:opacity-40 bg-[url('/assets/img/img_7.jpg')]">
            <div className="container relative z-1 table h-full">
                <div className="text-center py-[90px] max-sm:py-10 table-cell align-middle h-[250px] max-sm:h-[230px]">
                    <h1 className="mb-2.5 lg:text-4.5xl md:text-3xl sm:text-2.5xl text-2xl text-white">How to grow vegetables</h1>
                    <h2 className="mb-2.5 text-white text-sm">Discover easy, step-by-step guides for growing vegetables at home, in the garden, or on your balcony. Learn soil requirements, watering schedules, and organic care tips for each plant.</h2>
                    <nav>
                        <ul className="text-white">
                            ...
                            <li className="mr-[3px] pl-2 inline-block text-base font-medium"><ChevronRight size={16} className="inline-block -mt-[6px] mr-2"/> Vegetables</li>
                        </ul>
                    </nav>
                </div>
            </div>
