                                                    ...
                                                    <div className="lg:py-6 lg:pr-16 col-span-full">
                                                        ...
                                                        <Step step={2} heading="Step 2: Prepare the seedling tray (Recommended for beginners)">
                                                            <ul className="flex flex-col gap-2 text-gray-700">
                                                                ...
                                                                <li><MoveRight size={18} className="-mt-2 mr-2"/> <strong>Tip: </strong> See the <TabLink section="Seeding Process">Seeding process</TabLink> on this page for tips and thing to care.</li>
                                                            </ul>
                                                        </Step>
                                                        ...
                                                        <Step step={5} heading="Day 15: First organic fertilizer">
                                                            <ul className="flex flex-col gap-2 text-gray-700">
                                                                ...
                                                                <li><MoveRight size={18} className="-mt-2 mr-2"/> Onion peel fertilizer is rich in Potassium, Phosphorus, Nitrogen, Calcium, Iron, Magnesium, see <TabLink section="Nutritional Requirements">nutritional requirement</TabLink> section for more information.</li>
                                                        ...
                                                        <Step step={6} heading="Day 28: Shift to larger pot (Only if you planted in seedling tray)">
                                                            <ul className="flex flex-col gap-2 text-gray-700">
                                                        ...
                                                        <Step step={13} is_last={true} heading="Continue">
                                                            <>
                                                                ...
                                                                <p className="my-2">
                                                                    ...
                                                                    Check <TabLink section="Watering Schedule">watering section</TabLink> for more information.
                                                                </p>
                                                                ...
                                                                <p className="my-2">
                                                                    ...
                                                                    Perform Pinching <br/>
                                                                    Remove Suckers <br/>
                                                                    Check <TabLink section="Weeding & Caring">weeding & caring</TabLink> section for more information.
                                                                </p>
                                                                ...
                                                                <p className="my-2">
                                                                    ...
                                                                    Check <TabLink section="Fertilizer Requirements">fertilizer section</TabLink> for more information.
                                                                </p>
                                                                ...
                                                                <p className="my-2">
                                                                    ...
                                                                    Check <TabLink section="Diseases - Know & Treat">diseases section</TabLink> for more information.
                                                                </p>
                                                                ...
                                                                <p className="my-2">
                                                                    ...
                                                                    Check <TabLink section="Diseases - Know & Treat">Flowers withering (No Pollination) section</TabLink> for more information.
                                                                </p>
                                                            </>
                                                        </Step>
                                                    </div>
