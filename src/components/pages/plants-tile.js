...
const imgs = [
    "rounded-tr-7xl group-hover:rounded-tr-3xl",
    "rounded-br-7xl group-hover:rounded-br-3xl",
    "rounded-bl-7xl group-hover:rounded-bl-3xl",
    "rounded-tl-7xl group-hover:rounded-tl-3xl",
    "rounded-tr-7xl group-hover:rounded-tr-3xl",
    "rounded-br-7xl group-hover:rounded-br-3xl",
    "rounded-bl-7xl group-hover:rounded-bl-3xl",
    "rounded-tl-7xl group-hover:rounded-tl-3xl",
            ...
            return <div key={i} className={cn("col-span-3 col-span-2 col-span-4", row[col])}>
                <div className="group relative z-1 mb-13.5 max-lg:mb-0 pl-10 max-lg:pl-0">
                    <Link href={plant.ref.path}>
                        <Image width={400} height={300} src={plant.ref.cover} alt={plant.ref.seo.title} className={cn("w-full h-[300px] max-sm:h-[150px] object-cover border-4 border-white duration-500 rounded-tr-7xl rounded-br-7xl rounded-bl-7xl rounded-tl-7xl group-hover:rounded-tr-3xl group-hover:rounded-br-3xl group-hover:rounded-bl-3xl group-hover:rounded-tl-3xl rounded-3xl", randomItem(imgs))}/>
