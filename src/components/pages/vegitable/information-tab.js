            ...
            <div className="w-full m-lg-b0 m-md-b30">
                ...
                <div className="flex flex-col gap-0">
                    ...
                    <div className="w-full bg-darkGreen bg-no-repeat bg-auto -mt-1" style={{backgroundImage: 'url("/assets/other/image/bg-bn5-1.webp")', backgroundPosition: "center left"}}>
                        <div className="background-overlay bg-no-repeat" style={{backgroundImage: 'url("/assets/other/image/bg-bn5-2.webp")', backgroundPosition: "center right"}}>
                                ...
                                <div className="col-span-full md:col-span-3">
                                    <div className="flex flex-col pb-7 gap-4 text-white" id="info-ayurveda">
                                        ...
                                        <div className="flex flex-row items-center gap-4 mt-10">
                                            <Image className="h-[40px] w-[40px]" decoding="async" width={50} height={50} alt={plant.name} src="/assets/theme/icons/icon5-3.webp"/>
                    ...
                    <div className="w-full bg-no-repeat bg-auto" style={{backgroundImage: "url(/assets/theme/images/background/bg-product2.webp)", backgroundPosition: "bottom center"}}>
                        <div className="container mx-auto py-28 text-white">
                            <div className="grid grid-cols-12 gap-4 py-8">
                                <div className="banner-left col-span-12 md:col-span-6 lg:mt-0 mt-8 wow fadeInLeft hidden md:block">
                                    <div className=" relative text-center">
                                        <Image width={600} height={710} decoding="async" alt={plant.seo.title} src="/assets/theme/images/background/healthy-food.webp" className=" inline-block  relative elementor-repeater-item-c225823"/>
                                    </div>
                                </div>
                                <div className="col-span-12 md:col-span-6 relative lg:order-1 -order-1 wow fadeInRight">
